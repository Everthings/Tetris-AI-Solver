...
public class Game extends JPanel{
	...
	Game(AI ai, int width, int height){
		this.ai = ai;
		this.width = width;
		this.height = height;
	...
	void decideOrientation() {
		...
		currentPiece.centerPos = new Pair(startX.get(index), area.getHeight() + 1);
		for(int i = 0; i < rotations.get(index); i++)
			currentPiece.rotate(Direction.CLOCKWISE);
	}
